...
public sealed class DirectorySchema : BaseSchema
{
    ...
    private Dictionary<string, Columnid> ColumnsByAttributeName
    {
        get;
        set;
    }

    private Dictionary<string, DNTag> ObjectCategoriesByName
    {
        get;
        set;
    }

    private Dictionary<ClassType, DNTag> ObjectCategoriesByGovernsId
    {
        get;
        set;
    }
