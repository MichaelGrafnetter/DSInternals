...
FormatsToProcess = @(
    ...
    'Views\DSInternals.ProtectionKeyIdentifier.format.ps1xml',
...
AliasesToExport = @(
    ...
    'New-ADNgcKey',
    'New-CngDpapiNamedDescriptor',
    'Get-CngDpapiNamedDescriptor',
    'Remove-CngDpapiNamedDescriptor',
    'Protect-CngDpapiData',
    'Unprotect-CngDpapiData',
    'Get-CngDpapiData',
    'Get-CngDpapiPfxCertificate',
    'Unprotect-CngDpapiPfxCertificate',
    'Get-CngDpapiSidKeyIdentifier',
    'Save-CngDpapiSidKey',
    'Clear-CngDpapiSidKeyCache',
    'Remove-DpapiNgSidKey',
    'Remove-CngDpapiSidKey',
    ...
    'Get-ADSIGroupManagedServiceAccount',
