...
namespace DSInternals.Common.Cryptography.Asn1.Pkcs7
{
    ...
    internal partial struct RecipientKeyIdentifier
    {
        ...
        internal static void Decode(ref AsnReader reader, ReadOnlyMemory<byte> rebind, out RecipientKeyIdentifier decoded)
        {
        ...
        internal static void Decode(ref AsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out RecipientKeyIdentifier decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref AsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out RecipientKeyIdentifier decoded)
        {
            decoded = default;
