...
public static class Validator
{
    ...
    public static void AssertLength(string value, int length, [CallerArgumentExpression(nameof(value))] string? paramName = null)
    {
    ...
    public static void AssertMaxLength(SecureString password, int maxLength, [CallerArgumentExpression(nameof(password))] string? paramName = null)
    {
    ...
    public static void AssertMaxLength(string input, int maxLength, [CallerArgumentExpression(nameof(input))] string? paramName = null)
    {
    ...
    public static void AssertMaxLength(byte[] input, int maxLength, [CallerArgumentExpression(nameof(input))] string? paramName = null)
    {
        ArgumentNullException.ThrowIfNull(input, paramName);
    ...
    public static void AssertMinLength(byte[] data, int minLength, [CallerArgumentExpression(nameof(data))] string? paramName = null)
    {
    ...
    public static void AssertMinLength(ReadOnlyMemory<byte> data, int minLength, [CallerArgumentExpression(nameof(data))] string? paramName = null)
    {
        if (data.Length < minLength)
        {
            var exception = new ArgumentOutOfRangeException(paramName, data.Length, "The input is shorter than the minimum length.");
    ...
    public static void AssertLength(byte[] value, long length, [CallerArgumentExpression(nameof(value))] string? paramName = null)
    {
        ArgumentNullException.ThrowIfNull(value, paramName);
