namespace DSInternals.Common.Data
{
    ...
    public class KeyCredential
    {
        ...
        public KeyMaterialFido FidoKeyMaterial
        {
            get
            {
                if (this.Usage == KeyUsage.FIDO && this._cachedFidoKeyMaterial == null && this.RawKeyMaterial != null)
                {
                    ...
                    this._cachedFidoKeyMaterial = JsonSerializer.Deserialize<KeyMaterialFido>(fidoCredString, DsiJson.ReaderOptions);
                }
        ...
        public string ToJson() => DSInternals.Common.Serialization.DsiJson.Serialize(this);
