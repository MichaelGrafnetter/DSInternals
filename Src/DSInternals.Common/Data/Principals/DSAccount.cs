...
/// <summary>
/// Represents an Active Directory security principal (user, computer, or trust account).
/// </summary>
public class DSAccount
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DSAccount"/> class.
    /// </summary>
    /// <param name="dsObject">The directory object containing the account data.</param>
    ...
    /// <summary>
    /// Gets the primary group identifier for this <see cref="DSAccount"/>.
    /// </summary>
    /// <value>
