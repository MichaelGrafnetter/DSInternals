...
public class ProtectionKeyIdentifierTester
{
    ...
    {
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => new ProtectionKeyIdentifier(null));
    }

    [TestMethod]
    public void ProtectionKeyIdentifier_Empty()
    {
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => new ProtectionKeyIdentifier(new byte[0]));
    }
    ...
    public void ProtectionKeyIdentifier_Truncated1()
    {
        ...
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => new ProtectionKeyIdentifier(blob));
    }
