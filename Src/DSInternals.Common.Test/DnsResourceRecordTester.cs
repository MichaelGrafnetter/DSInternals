namespace DSInternals.Common.Test
{
    ...
    public class DnsResoutceRecordTester
    {
        ...
        public void DnsResoutceRecord_ZERO()
        {
            ...
            var record = DnsResourceRecord.Parse(input);
            ...
            Assert.AreEqual("2025-02-10 11:59:49Z", record.Data);
        }
        ...
        {
            throw new AssertInconclusiveException("DHCID record type is not yet supported.");
        }
