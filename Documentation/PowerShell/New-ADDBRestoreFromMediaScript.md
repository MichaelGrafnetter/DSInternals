...
## DESCRIPTION
WARNING: This recovery procedure is NOT SUPPORTED by Microsoft. Use at your own risk in situations when you are facing Active Directory forest reinstallation.

To perform a Restore from Media (RFM, &copy; Michael Grafnetter) operation, you need to have the following:
...
- Reset the InvocationID of the domain controller.
...
### Example 4
Here is a sample PowerShell script generated by the New-ADDBRestoreFromMediaScript cmdlet:
